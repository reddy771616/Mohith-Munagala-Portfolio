  ...
  return (
    <section id="contact" className="flex flex-col gap-5 bg-gradient-to-br from-cyan-600/20 via-blue-600/20 to-purple-600/20 border-2 border-cyan-400/50 rounded-3xl p-6 sm:p-8 shadow-2xl animate-fade-in-up">
      ...
      <div className="flex flex-wrap gap-4">
        <a className="inline-flex items-center justify-center px-8 py-4 rounded-xl font-black no-underline transition-all bg-gradient-to-r from-pink-500/30 to-rose-500/30 text-white border-2 border-pink-400/60 shadow-xl min-w-[200px] hover:bg-pink-500/50 hover:border-pink-400/80 hover:-translate-y-2 hover:shadow-pink-500/50 hover:scale-110 transform duration-300 text-lg animate-fade-in-up" href="https://mail.google.com/mail/?view=cm&fs=1&to=mohithmunagala14@gmail.com" target="_blank" rel="noopener noreferrer">
          Email Mohith
        </a>
        <a className="inline-flex items-center justify-center px-8 py-4 rounded-xl font-black no-underline transition-all bg-gradient-to-r from-pink-500/30 to-rose-500/30 text-white border-2 border-pink-400/60 shadow-xl min-w-[200px] hover:bg-pink-500/50 hover:border-pink-400/80 hover:-translate-y-2 hover:shadow-pink-500/50 hover:scale-110 transform duration-300 text-lg animate-fade-in-up" style={{ animationDelay: '0.1s' }} href="tel:+12175120363">
          Call / Text
        </a>
        <a className="inline-flex items-center justify-center px-8 py-4 rounded-xl font-black no-underline transition-all bg-gradient-to-r from-pink-500/30 to-rose-500/30 text-white border-2 border-pink-400/60 shadow-xl min-w-[200px] hover:bg-pink-500/50 hover:border-pink-400/80 hover:-translate-y-2 hover:shadow-pink-500/50 hover:scale-110 transform duration-300 text-lg animate-fade-in-up" style={{ animationDelay: '0.2s' }} href="https://www.linkedin.com/in/mohith-munagala-48179b1b1/" target="_blank" rel="noopener noreferrer">
          LinkedIn
        </a>
        <a className="inline-flex items-center justify-center px-8 py-4 rounded-xl font-black no-underline transition-all bg-gradient-to-r from-pink-500/30 to-rose-500/30 text-white border-2 border-pink-400/60 shadow-xl min-w-[200px] hover:bg-pink-500/50 hover:border-pink-400/80 hover:-translate-y-2 hover:shadow-pink-500/50 hover:scale-110 transform duration-300 text-lg animate-fade-in-up" style={{ animationDelay: '0.3s' }} href="https://github.com/reddy771616" target="_blank" rel="noopener noreferrer">
          GitHub
        </a>
      </div>
    </section>
